        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-6">
          <div className="lg:col-span-2">
            ...
            <div className="mt-4 flex items-center gap-4">
              <a
                href="https://www.facebook.com/profile.php?id=100091977414961"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="TejasFinserv Facebook"
                className="inline-flex items-center text-ivory/70 transition-all duration-200 hover:text-[#1877F2] hover:scale-110"
              >
                <svg
